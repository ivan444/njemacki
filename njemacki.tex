...
\newcommand{\odvojidusie}{\renewcommand{\internoodvojenodusie}{\boolean{true}}}
\newcommand{\spojidusie}{\renewcommand{\internoodvojenodusie}{\boolean{false}}}
\newcommand{\internoodvojenodusie}{\boolean{false}}
...
{%
  \begin{table}[H]
    ...
    \multirow{6}{2mm}{\begin{sideways}\parbox{23mm}{Sadašnjost}\end{sideways}}
      ...
      \ifthenelse{\internoodvojenodusie}
        {%
          & \internoti & \internodu \\
          & Vi \internovi & Sie \internosie \\ }
        {& \internoti/Vi \internovi & \internodu/Sie \internosie\\ }
    ...
    \multirow{6}{2mm}{\begin{sideways}\parbox{18mm}{Prošlost}\end{sideways}}
      ...
      \ifthenelse{\internoodvojenodusie}
        ...
        {& \internopti/Vi \internopvi & \internopdu/Sie \internopsie\\ }
    ...
    \end{tabular}
  \end{table}
  % Vrati du/sie na standardnu postavku (spojeno).
  \spojidusie}
