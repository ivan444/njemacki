...
\section{Genitiv}
Izražava posjedovanje. Tvorba:
\begin{itemize}
  \item Imenice u \emph{muškom} rodu dobivaju nastavak \nastavak{s}:\\
    \primjer{Mutters Bruder}{Majčin brat}
  \item Imenicama u \emph{ženskom} rodu član se mijenja u \clan{der}.
  \item Kod imenica u \emph{srednjem} rodu član se mijenja u \clan{des} i dobivaju nastavak \nastavak{s}:\\
