...
\begin{glagoltbl}{u pasivu (glagolski oblik ostaje isti -- \emph{gefragt})}
  \ja{sam pitan}  \ich{werde gefragt}
  \ti{si \ditto} \du{wirst \ditto}
  \ono{je \ditto}  \es{wird \ditto}
  \mi{smo \ditto} \wir{werden \ditto}
  \vi{ste \ditto} \ihr{werdet \ditto}
  \oni{su \ditto}  \sie{werden \ditto}

  \pja{bio pitan}  \pich{wurde gefragt}
  \pti{bio \ditto} \pdu{wurdest \ditto}
  \pon{bio \ditto}  \pes{wurde \ditto}
  \pmi{bili \ditto} \pwir{wurden \ditto}
  \pvi{bili \ditto} \pihr{wurdet \ditto}
  \poni{bili \ditto}  \psie{wurden \ditto}
\end{glagoltbl}
